class Drink
  ...
  def initialize(drink_data)
    @name = drink_data[:attributes][:name]
                ...
                @drink_measurements = {
                  drink_data[:attributes][:ingredient_1] => drink_data[:attributes][:measurement_1],
                  drink_data[:attributes][:ingredient_2] => drink_data[:attributes][:measurement_2],
                  drink_data[:attributes][:ingredient_3] => drink_data[:attributes][:measurement_3],
                  drink_data[:attributes][:ingredient_4] => drink_data[:attributes][:measurement_4],
                  drink_data[:attributes][:ingredient_5] => drink_data[:attributes][:measurement_5],
                  drink_data[:attributes][:ingredient_6] => drink_data[:attributes][:measurement_6],
                  drink_data[:attributes][:ingredient_7] => drink_data[:attributes][:measurement_7],
                  drink_data[:attributes][:ingredient_8] => drink_data[:attributes][:measurement_8],
                  drink_data[:attributes][:ingredient_9] => drink_data[:attributes][:measurement_9],
                  drink_data[:attributes][:ingredient_10] => drink_data[:attributes][:measurement_10],
                  drink_data[:attributes][:ingredient_11] => drink_data[:attributes][:measurement_11],
                  drink_data[:attributes][:ingredient_12] => drink_data[:attributes][:measurement_12],
                  drink_data[:attributes][:ingredient_13] => drink_data[:attributes][:measurement_13],
                  drink_data[:attributes][:ingredient_14] => drink_data[:attributes][:measurement_14],
                  drink_data[:attributes][:ingredient_15] => drink_data[:attributes][:measurement_15]
                }
